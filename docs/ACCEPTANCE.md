...
结果与日志保存在 `verification/`。测试数据的构成和来源见 [TEST_DATA.md](TEST_DATA.md)，已验证环境及运行记录见 [DELIVERY.md](../verification/DELIVERY.md)。
...
| [测试记录](../verification/DELIVERY.md) | 已执行的测试、环境、提交和构建标识 |
