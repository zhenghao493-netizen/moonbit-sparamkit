...
Scope: `0.1.0-dev.3`, one/two-port single-ended S parameters. This is an implementation contract, **not full Touchstone conformance**.
...
| Comments/blank lines | `!` to physical end of line; arbitrary comment text ignored | Comment/line-ending tests |
...
| Vendor comment metadata | Not interpreted, including `! Port Impedance` | **Do not use** files whose impedance depends on these comments instead of common header R; measured fixture tests only cover matching real references |
